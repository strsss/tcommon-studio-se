...
//
// ============================================================================
package org.talend.core.ui.login.sandbox;
            ...
            public void run(final IProgressMonitor monitor) throws InvocationTargetException, InterruptedException {
                ...
                disp.syncExec(new Runnable() {
                    ...
                    public void run() {
                        ...
                        boolean ok = false;
                        try {
                            Project createProject = CoreRuntimePlugin.getInstance().getRepositoryService()
                                    .getProxyRepositoryFactory().createProject(projectInfor);
