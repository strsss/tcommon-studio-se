...
public class ConnectionFormComposite extends Composite {
    ...
    public ConnectionFormComposite(Composite parent, int style, ConnectionsListComposite connectionsListComposite,
        ...
        Label workSpaceLabel = toolkit.createLabel(formBody, Messages.getString("connections.form.workspace")); //$NON-NLS-1$
        ...
        workSpaceButton.setToolTipText(Messages.getString("connections.form.selectWorkspace")); //$NON-NLS-1$
    ...
    private boolean validateFields() {
        ...
        if (valid && getRepository() == null) {
            ...
            errorMsg = Messages.getString("connections.form.workspaceInvalid"); //$NON-NLS-1$
